  ...
  <div class="container-wide py-8 lg:py-10">
    ...
    <template v-else-if="script">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <h1 class="text-xl lg:text-2xl font-mono font-normal text-surface-100 truncate">{{ script.concept }}</h1>
        <div class="flex gap-2">
          <UiButton variant="secondary" size="sm" :disabled="exporting" @click="exportAs('json')">
            <UiIcon name="Download" :size="16" />
            Export JSON
          </UiButton>
          <UiButton variant="ghost" size="sm" :disabled="exporting" @click="exportAs('markdown')">
