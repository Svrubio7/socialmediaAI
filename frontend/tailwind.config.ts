...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-sm': '0 0 15px -3px rgba(225, 246, 144, 0.35)',
        'glow-md': '0 0 25px -5px rgba(225, 246, 144, 0.45)',
        'glow-lg': '0 0 35px -5px rgba(225, 246, 144, 0.55)',
        'glow-accent': '0 0 25px -5px rgba(124, 251, 253, 0.35)',
      },
      backgroundImage: {
