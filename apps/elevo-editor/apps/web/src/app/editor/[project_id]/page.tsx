...
const SocialMediaAiDiagnosticsPanel = dynamic(
	() =>
		import("@/components/editor/socialmediaai-diagnostics-panel").then(
			(mod) => mod.SocialMediaAiDiagnosticsPanel,
		),
	{ ssr: false },
);
