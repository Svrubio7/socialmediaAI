...
import { OcVideoIcon } from "@elevo-editor/ui/icons";
...
import { buildEditorProjectPath } from "@/integrations/socialmediaai/project-adapter";
...
function NewProjectButton() {
	...
	const handleCreateProject = async () => {
		...
		router.push(buildEditorProjectPath(projectId));
	};
...
function ProjectItem({
	...
	const listContent = (
		...
		>
			...
			<Link href={buildEditorProjectPath(project.id)} className="flex-1 min-w-0">
				{listRowContent}
			</Link>
	...
	return (
		<div className="group relative">
			<Link href={buildEditorProjectPath(project.id)} className="block">
				{cardContent}
			</Link>
